...
export function HomeSection() {
  ...
  return (
    ...
    >
      ...
      <div className="sm:w-[85vw] qhd:w-[75vw] flex flex-col xl:flex-row items-center justify-start gap-6 md:gap-10">
        ...
        <div className="relative max-w-275 qhd:max-w-5xl flex flex-col items-center xl:items-start justify-center gap-4 sm:gap-6 lg:gap-8 text-center xl:text-start">
          ...
          <motion.div
            variants={fadeUpVariant}
            className="max-w-4xl xl:max-w-3xl 2xl:max-w-4xl qhd:qhd:max-w-5xl flex flex-col gap-2 text-start"
          >
