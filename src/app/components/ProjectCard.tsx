...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="relative w-83 xl:w-md fhd:w-117 qhd:w-127 h-115 xl:h-128 fhd:h-132 p-2.5 xl:p-3 fhd:p-5 rounded-2xl bg-card text-foreground flex flex-col items-start justify-start gap-4">
      <Link
      ...
      <div className="mt-auto flex flex-col items-start justify-start gap-2">
        <div className="flex items-center justify-start gap-2">
          <Badge label={status.label} backgroundColor={status.backgroundColor} textSize="text-[0.575rem] xl:text-[0.650rem] fhd:text-xs" />
          <Badge label={category.label} backgroundColor={category.backgroundColor} textSize="text-[0.575rem] xl:text-[0.650rem] fhd:text-xs" />
        </div>
        <div className="flex items-center justify-start gap-2 flex-wrap">
          {project.technologies.map((tech) => (
            <Badge
              ...
              textSize="text-[0.575rem] xl:text-[0.650rem] fhd:text-xs"
            />
          ))}
        </div>
      </div>
