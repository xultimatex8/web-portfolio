...
export function TimelineItem({ title, subtitle }: TimelineItemProps) {
  return (
    <div className="relative w-2xl xl:w-7xl">
      ...
      <div className="ml-10 h-28 xl:h-32 bg-card rounded-2xl p-6 flex flex-col justify-center">
        <h2 className="text-xl xl:text-2xl font-semibold text-foreground">{title}</h2>
        <p className="text-base xl:text-lg text-foreground-secondary">{subtitle}</p>
      </div>
    </div>
  );
}