export function ExperienceSection() {
  return (
    <section
      id="experience"
      className="relative w-full py-10 lg:py-20 fhd:py-30 flex flex-col lg:flex-row items-start justify-start gap-6 lg:gap-20 px-6 lg:px-15"
    >
      ...
      <div className="max-w-4xl flex flex-col items-start justify-center gap-4">
        <p className="text-base lg:text-xl 2xl:text-2xl text-foreground">
