export function ExperienceSection() {
  return (
    <section
      id="experience"
      className="relative w-full py-20 xl:py-30 flex items-start justify-start gap-20 px-15"
    >
      <h1 className="w-xs text-4xl xl:text-6xl font-bold tracking-tight text-foreground sticky top-30">
        Experience
      </h1>
      ...
      <div className="max-w-4xl flex flex-col items-start justify-center gap-4">
        <p className="text-xl xl:text-2xl text-foreground">
          I&apos;m about to graduate and currently looking for my first professional
          opportunity in Software Engineering.
        </p>
        <p className="text-base xl:text-lg text-foreground-secondary">
