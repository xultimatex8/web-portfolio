export function ExperienceSection() {
  return (
    ...
    >
      <h1 className="w-xs text-4xl fhd:text-6xl font-bold tracking-tight text-foreground sticky top-30">
        Experience
      </h1>
      ...
      <div className="max-w-4xl flex flex-col items-start justify-center gap-4">
        <p className="text-xl fhd:text-2xl text-foreground">
          I&apos;m about to graduate and currently looking for my first professional
          opportunity in Software Engineering.
        </p>
        <p className="text-base fhd:text-lg text-foreground-secondary">
