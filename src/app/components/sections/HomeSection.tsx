    ...
    >
      <div className="flex items-center justify-start gap-10">
        ...
        <div className="relative max-w-275 flex flex-col items-start justify-center gap-8 text-start">
          <div className="flex flex-col items-start justify-center gap-1">
            <motion.h1
              variants={fadeUp}
              className="text-6xl xl:text-8xl font-bold tracking-tight text-foreground"
            >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-4xl xl:text-6xl font-medium tracking-tight text-foreground-secondary"
            >
              Final-Year{" "}
      ...
      >
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-sm xl:text-lg flex flex-wrap gap-3">
        ...
        <div className="flex flex-col items-start justify-center gap-4 text-lg xl:text-xl text-foreground">
          <p>
